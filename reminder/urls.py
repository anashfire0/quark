...
urlpatterns = [
    ...
    re_path(r'^api/list/$', views.ReminderListRest.as_view(), name='reminder_list_rest'),

    re_path(r'^api/list/(?P<pk>\d+)/$', views.ReminderDetailRest.as_view(), name='reminder_detail_rest'),
